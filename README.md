...
### [⬇ Download WMLSTudio — Windows portable ZIP](https://github.com/iowa69/WMLSTudio/releases/download/v0.3.4/WMLSTudio-0.3.4-Windows-x64.zip)

**v0.3.4 · Windows x64 · 390 MB ZIP · Non-commercial research**
...
[Release notes](https://github.com/iowa69/WMLSTudio/releases/tag/v0.3.4)
· [SHA-256 checksum](https://github.com/iowa69/WMLSTudio/releases/download/v0.3.4/WMLSTudio-0.3.4-Windows-x64.zip.sha256)
